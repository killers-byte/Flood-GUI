...
-- 🔥 FIXED: ALL MAPS FARM (INCLUDING CRAZY+)
-- 🔥 NO MORE FLOATING / RESPAWN BUG
-- ============================================
...
local function OnMapLoad(map)
    ...
    -- ✅ JIKA BLACKLIST, SKIP DAN JALAN KE LIFT
    ...
    -- ✅ SELAIN BLACKLIST, LANGSUNG FARM TANPA PEDULI DIFFICULTY
    ...
    -- HAPUS PENGECEKAN DIFFICULTY YANG MERESET KARAKTER
    -- Biarkan semua map di-farm
    ...
    -- Update stats dengan difficulty yang terdeteksi
    local _, diffName = GetDifficulty()
    if diffName and diffName ~= "Unknown" then
        updateStats(diffName)
    else
        updateStats("Crazy")
    end
    rotateMap()
