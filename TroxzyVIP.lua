...
-- 🔥 FIXED: PREMIUM AUTHENTICATION UI & CACHE BYPASS + HWID SYSTEM
-- ============================================
...
local function supremeKeyValidation()
    ...
    -- Base URL
    local BASE_KEYS_URL = "https://gist.githubusercontent.com/killers-byte/4cd78cad4c3cf8e62e90cd7f8c82624b/raw/bdd6269e53e1da45271532beca9af539c7abe250/TroxzyKey.json"
    ...
    local function checkKey(rawInput)
        ...
        -- ==========================================
        -- 🛡️ [NEW] HWID / USERID AUTHENTICATION
        -- ==========================================
...
loadStats()
setupAutoReconnect()
notify("SPECTRAL BLADE v22.1 - HWID Protected", "System")
print("TROXZY: Spectral Blade v22.1 Auth Fixed & Protected.")
