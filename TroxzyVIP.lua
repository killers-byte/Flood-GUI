...
-- -- ============================================
-- TROXZY VIP v16.7 [UI GAP FIXED]
-- 🔥 CanvasSize pas, nggak ada ruang kosong di bawah konten
-- 📱 100% Mobile Optimized
-- ============================================
...
-- 🔥 FIX: updateScrollSize tanpa tambahan berlebih
local function updateScrollSize(tabKey)
    ...
    tabContents[tabIdx].scroll.CanvasSize = UDim2.new(0,0,0,tabContents[tabIdx].layout.AbsoluteContentSize.Y)
end
...
print("Troxzy VIP v16.7 - UI Gap Fixed")
print("CanvasSize matches content exactly, zero empty space")
local RunService = game:GetService("RunService")
local Players = game:GetService("Players")
local Workspace = game:GetService("Workspace")
local Lighting = game:GetService("Lighting")
